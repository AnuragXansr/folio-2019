...
export default class Controls extends EventEmitter {
    ...
    setKeyboard() {
        ...
        if (this.tt == 0) {
            this.keyboard.events.keyDown1 = (_event) => {
                switch (_event.key) {
                    case "ArrowUp":
                    case "z":
            ...
            this.keyboard.events.keyUp1 = (_event) => {
                switch (_event.key) {
                    case "ArrowUp":
                    case "z":
                        this.actions.up = false;
            ...
            document.addEventListener("keydown", this.keyboard.events.keyDown1);
            document.addEventListener("keyup", this.keyboard.events.keyUp1);
        } else {
